...
public class CRC8 {
    ...
    public static void main(String[] args) {
        byte[] data = new byte[] { 0x20, 0, 1, 0, 0, 0, 0, (byte)0xA1,1, 0, 1 };
        byte crc = CRC8.calcCrc8(new byte[] { 20, 0, 1, 0, 0, 0, 0, (byte)0xA1, 0, 1 });
        System.out.println("" + Integer.toHexString(0x00ff & crc));
        byte crc2 = calcXor(data);
        System.out.println("" + Integer.toHexString(0x00ff & crc2));


    }

    public static byte calcXor(byte[] datas){
        byte temp=datas[0];
